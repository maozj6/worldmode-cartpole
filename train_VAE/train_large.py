...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        for batch_idx, data in enumerate(TestLoader):
            ...
            pbar.update(1)
        save_image(data, 'real_large_figs_vae/gt_{}.png'.format(epoch), range=(0, 1))
        save_image(recon_batch, 'real_large_figs_vae/reconstructed_{}.png'.format(epoch), range=(0, 1))
        pbar.close()
        print('  ====> Epoch: {} Average loss: {:.4f}'.format(
